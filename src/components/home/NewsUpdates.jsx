        ...
        <div className="px-6 md:px-12 mb-10 flex items-end justify-between">
          <div className="flex items-center gap-4">
            ...
            <div>
              ...
              <p className="font-sans text-[10px] font-bold text-slate-500 tracking-[0.2em] uppercase">Live Updates</p>
            </div>
          </div>
        </div>
                ...
                return (
                  ...
                  >
                    ...
                    <div className="relative h-full rounded-[1.25rem] overflow-hidden bg-slate-950 border border-white/10 shadow-xl transition-transform duration-500 group-hover:-translate-y-2 group-hover:shadow-white/5">
                      ...
                      <div className="h-[55%] p-4 flex flex-col justify-between bg-slate-950 relative">
                        <div className="absolute top-0 left-0 right-0 h-[1px] bg-gradient-to-r from-transparent via-white/20 to-transparent"></div>

                        <div className="relative z-10">
                          <h4 className="font-serif text-sm md:text-base text-white leading-[1.25] line-clamp-4 group-hover:text-slate-200 transition-colors tracking-tight">
                            {item.title}
                          </h4>
                        </div>
