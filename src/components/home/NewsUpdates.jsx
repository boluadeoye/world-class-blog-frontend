      ...
      <div className="w-full max-w-7xl mx-auto">
        ...
        <div className="px-6 md:px-12 mb-10 flex items-end justify-between">
          <div className="flex items-center gap-4">
            ...
            <div>
              <h3 className="font-serif text-2xl md:text-3xl text-white leading-none mb-1.5 tracking-tight">Global Tech Feed</h3>
                ...
                >
                  ...
                  <div className="h-full p-5 rounded-xl bg-slate-950 border border-white/10 hover:border-indigo-500/40 transition-all duration-500 flex flex-col justify-between overflow-hidden shadow-lg group-hover:shadow-xl group-hover:shadow-indigo-900/10">
                    ...
                    <div className="relative z-10 mt-auto pt-3 border-t border-white/5 flex items-center justify-between">
                      <span className="text-[10px] font-sans font-medium text-slate-500 group-hover:text-indigo-400 transition-colors tracking-wide">
                        {new Date(item.pubDate).toLocaleDateString('en-US', { month: 'short', day: 'numeric' })}
                      </span>
                      <div className="flex items-center gap-1.5 text-[9px] font-bold text-slate-600 uppercase tracking-widest group-hover:text-slate-300 transition-colors font-sans">
                        <span>Read</span>
