...
/* === GLASS STATUS PILL (Thicker & Sharper) === */
function SystemStatus() {
  ...
  return (
    <div className="inline-flex items-center gap-3 px-4 py-2 rounded-full bg-white/10 border border-white/20 backdrop-blur-md shadow-[0_0_15px_rgba(16,185,129,0.2)] whitespace-nowrap">
        ...
        <div className="relative bg-[#020617]/90 backdrop-blur-xl rounded-[2.5rem] overflow-hidden shadow-2xl shadow-indigo-900/20 border border-white/10">
          ...
          <div className="relative z-10 p-6 md:p-16 flex flex-col">
            ...
            <div className="max-w-5xl">
              ...
              >
                <div className="h-[4px] w-24 bg-amber-500 rounded-full shadow-[0_0_15px_rgba(245,158,11,0.6)]"></div>
                {/* BOLD ROLE */}
