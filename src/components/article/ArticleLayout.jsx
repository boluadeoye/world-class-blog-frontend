...
export function ArticleHero({ post }) {
  ...
  return (
    <section className="relative pt-28 pb-12 px-6 overflow-hidden flex flex-col items-center text-center">
...
export function ArticleContent({ children }) {
  ...
  return (
    <div className="relative z-10 max-w-[720px] mx-auto px-6 pb-24">
      <ReadingTimer />
      ...
      <div className="mt-16 pt-8 border-t border-white/10 flex justify-between items-center">
        ...
        <div className="flex gap-3">
          <button 
            onClick={handleShare}
            className="group relative p-3 rounded-full bg-slate-800/50 hover:bg-indigo-600 text-slate-300 hover:text-white transition-all shadow-lg border border-white/5"
          >
          ...
          <button 
            onClick={handleSave}
            className={`p-3 rounded-full transition-all shadow-lg border border-white/5 ${isSaved ? 'bg-amber-500 text-black' : 'bg-slate-800/50 hover:bg-white hover:text-black text-slate-300'}`}
          >
