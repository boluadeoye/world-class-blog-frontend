...
import { ArrowLeft, Clock, Calendar, Share2, Bookmark, Check, ArrowUp } from "lucide-react";
  ...
  return (
    <section className="relative pt-32 pb-16 px-6 overflow-hidden flex flex-col items-center text-center">
      <div className="absolute inset-0 z-0 pointer-events-none">
        ...
        <div className="absolute top-0 left-1/4 w-[600px] h-[600px] bg-indigo-600/20 blur-[150px] rounded-full mix-blend-screen animate-pulse duration-[4s]"></div>
  ...
  return (
    <div className="relative z-10 max-w-[760px] mx-auto px-6 pb-24">
      ...
      <article className="prose prose-lg md:prose-xl prose-invert prose-slate max-w-none
        ...
        prose-p:text-slate-200 prose-p:leading-[1.8] prose-p:text-lg md:prose-p:text-[1.15rem] prose-p:text-left
