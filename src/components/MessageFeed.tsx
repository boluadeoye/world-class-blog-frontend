...
export const MessageFeed = memo(function MessageFeed({ messages, isThinking, streamingContent }: any) {
  ...
  return (
    <div className="flex flex-col relative w-full" style={{ flex: "1 1 0px", minHeight: 0, overflowY: "auto" }}>
      <div className="px-4 md:px-8 pt-8 pb-40 max-w-4xl mx-auto w-full flex flex-col gap-8">
        {messages.map((msg: any) => (
          <div key={msg.id} className="grid grid-cols-[32px_1fr] gap-4 w-full group">
            ...
            <div className="min-w-0">
              <div className="text-[11px] font-black uppercase tracking-[0.2em] text-white/30 mb-1.5">
        ...
        {(isThinking || streamingContent) && (
          <div className="grid grid-cols-[32px_1fr] gap-4 w-full">
            <div className="shrink-0 mt-0.5">
            ...
            <div className="min-w-0">
              <div className="text-[11px] font-black uppercase tracking-[0.2em] text-white/30 mb-1.5">Principal Architect</div>
