...
export default function PremiumHero() {
  ...
  const heroImage = process.env.NEXT_PUBLIC_HERO_IMAGE || "https://w5e7svgknmetlu9j.public.blob.vercel-storage.com/adeoye.jpg";
        ...
        <div className="grid grid-cols-12 gap-6 items-center">
          <div className="col-span-6">
            ...
            <div className="mt-6 flex flex-wrap items-center gap-3">
              ...
              <a href={contactUrl} className="ml-1 inline-flex items-center rounded-full bg-sky-600 px-4 py-2 text-sm font-semibold text-white shadow hover:bg-sky-500 transition">
                Let’s talk
              </a>
            </div>
          </div>
          ...
          <div className="col-span-6">
            <div className="relative aspect-[4/5] w-full overflow-hidden rounded-3xl border border-slate-800 bg-gradient-to-b from-slate-800/50 to-slate-900">
              {heroImage ? (
                ...
                <img alt="Portrait" src={heroImage} className="h-full w-full object-cover" loading="eager" />
