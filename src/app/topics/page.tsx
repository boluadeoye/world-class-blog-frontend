...
const TOPICS = [
  { 
    id: 'edu', 
    title: 'Education', 
    link: '/articles?q=Education',
    icon: BookOpen,
    desc: 'Lifelong learning strategies.'
  },
  { 
    id: 'tech', 
    title: 'Technology', 
    link: '/articles?q=Technology',
    icon: Terminal,
    desc: 'Software and digital systems.'
  },
  { 
    id: 'fin', 
    title: 'Finance', 
    link: '/articles?q=Finance',
    icon: TrendingUp,
    desc: 'Markets and capital allocation.'
  },
  { 
    id: 'des', 
    title: 'Design', 
    link: '/articles?q=Design',
    icon: PenTool,
    desc: 'Aesthetics and UI engineering.'
  },
  { 
    id: 'life', 
    title: 'Lifestyle', 
    link: '/articles?q=Lifestyle',
    icon: Activity,
    desc: 'Philosophy and personal growth.'
  },
  { 
    id: 'all', 
    title: 'Browse All', 
    link: '/articles',
    icon: Layers,
    desc: 'View the complete archive.'
  }
];
        ...
        <div className="flex flex-col md:flex-row md:items-end justify-between gap-8">
          <div className="space-y-4">
            ...
            <p className="text-slate-400 max-w-xl">
              Explore the archives by category or use the search below.
            </p>
          </div>
        ...
        {TOPICS.map((topic) => (
          ...
          >
            <div className="h-full p-8 rounded-2xl bg-[#0B1120] border border-white/5 hover:border-amber-500/50 transition-all duration-300 hover:-translate-y-1 hover:shadow-2xl hover:shadow-black/50">
              ...
              <h2 className="text-2xl font-serif text-white mb-2 group-hover:text-amber-400 transition-colors">
                {topic.title}
              </h2>
