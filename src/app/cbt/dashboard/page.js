      ...
      <header className="bg-[#004d00] text-white pt-10 pb-24 px-6 rounded-b-[3.5rem] shadow-2xl relative z-10 overflow-hidden">
        ...
        <div className="relative z-10">
          <div className="flex justify-between items-center mb-8">
            <div className="flex items-center gap-4">
              <div className="w-16 h-16 bg-white rounded-[1.5rem] flex items-center justify-center border-2 border-white/20 shadow-xl overflow-visible relative group">
                ...
                {isPremium && (
                  <div className="absolute -top-3 -right-3 bg-yellow-400 text-black p-2 rounded-full border-4 border-[#004d00] shadow-xl z-20 animate-bounce">
                    <Crown size={14} fill="currentColor" />
                  </div>
                )}
              </div>
              <div>
                <p className="text-emerald-300 text-[10px] font-black uppercase tracking-[0.2em] mb-1">{greeting}</p>
                <h1 className="text-2xl font-black leading-none truncate w-48 tracking-tighter">{student.name.split(" ")[0]}</h1>
              </div>
            </div>
            <div className="flex gap-3">
          ...
          <div className="bg-[#003300]/60 backdrop-blur-md border border-white/10 rounded-[2rem] p-6 flex items-center justify-between shadow-inner relative overflow-hidden">
            <div className="relative z-10">
              <p className="text-[10px] font-bold text-emerald-400 uppercase tracking-widest mb-1">Academic Status</p>
              <p className="font-black text-sm text-white tracking-widest flex items-center gap-2"><span className="w-2 h-2 rounded-full bg-emerald-500 animate-pulse"></span> SESSION 2026 ACTIVE</p>
            </div>
      ...
      <div className="px-6 -mt-12 relative z-20 space-y-10">
          ...
          <div className="bg-gradient-to-r from-blue-700 to-blue-900 rounded-[2.5rem] p-6 shadow-2xl shadow-blue-900/20 relative overflow-hidden active:scale-[0.98] transition-all duration-300">
            ...
            <div className="relative z-10 flex justify-between items-center">
              <div className="flex items-center gap-6">
                <div className="w-16 h-16 bg-white/20 rounded-2xl flex items-center justify-center border border-white/20 relative backdrop-blur-sm shadow-inner">
                ...
                <div>
                  <h2 className="text-white font-black text-lg uppercase tracking-widest mb-1">Community Forum</h2>
                  <p className="text-blue-100 text-[11px] font-bold opacity-80">Academic Discussions & Intel</p>
                </div>
              </div>
        ...
        <section>
           <div className="flex items-center justify-between mb-6 px-2">
             <div className="flex items-center gap-3"><div className="bg-emerald-100 p-2 rounded-xl text-emerald-800 shadow-sm"><BookOpen size={16} /></div><h2 className="font-black text-xs text-slate-500 uppercase tracking-[0.25em]">Course Directory</h2></div>
           </div>
        ...
        <section>
          <div className="flex items-center justify-between mb-4 px-2">
            <div className="flex items-center gap-2"><History size={16} className="text-slate-400" /><h2 className="font-black text-[10px] text-slate-400 uppercase tracking-widest">Recent Operations</h2></div>
            {examHistory.length > 2 && (<button onClick={() => setHistoryExpanded(!historyExpanded)} className="text-[10px] font-black text-emerald-600 uppercase tracking-widest flex items-center gap-1">{historyExpanded ? "Show Less" : "View All"} {historyExpanded ? <ChevronUp size={14} /> : <ChevronDown size={14} />}</button>)}
          </div>
        ...
        <section>
          <div className="flex items-center justify-between mb-6 px-2">
            <div className="flex items-center gap-3"><div className="bg-yellow-100 p-2 rounded-xl text-yellow-700 shadow-sm"><Trophy size={16} /></div><h2 className="font-black text-xs text-slate-500 uppercase tracking-[0.25em]">Hall of Legends</h2></div>
            <div className="flex items-center gap-2 bg-slate-900 text-white px-4 py-1.5 rounded-full shadow-lg"><div className="w-1.5 h-1.5 rounded-full bg-emerald-500 animate-pulse"></div><span className="text-[9px] font-black uppercase tracking-widest">Live</span></div>
          </div>
      ...
      <div className="fixed bottom-8 left-8 right-8 z-40 max-w-2xl mx-auto">
        <div className="bg-slate-900/95 backdrop-blur-2xl border border-white/10 shadow-[0_20px_50px_rgba(0,0,0,0.3)] rounded-[2rem] py-5 px-8 flex items-center justify-between">
          <div className="flex items-center gap-5 flex-1 min-w-0">
            <div className="w-12 h-12 bg-emerald-600 rounded-2xl flex items-center justify-center text-white shrink-0 shadow-[0_0_20px_rgba(16,185,129,0.4)]"><Award size={22} /></div>
            <div className="min-w-0">
              <h4 className="font-black text-xs text-white leading-none mb-1.5 uppercase tracking-widest">Bolu Adeoye</h4>
              <p className="text-[9px] text-slate-400 font-bold truncate uppercase tracking-widest opacity-70">Dept. of English & Literary Studies</p>
            </div>
          </div>
          <div className="h-10 w-[1px] bg-white/10 mx-6"></div>
          <div className="text-right shrink-0">
            <p className="text-[8px] font-black text-slate-500 uppercase tracking-[0.3em] mb-1">Partner</p>
            <p className="text-[11px] font-black text-white leading-none uppercase tracking-widest">Abel Kings</p>
            <p className="text-[8px] font-bold text-emerald-500 uppercase tracking-widest mt-1">Tutorial Center</p>
          </div>
        </div>
      </div>
    </main>
