...
export default function AdminDashboard() {
  ...
  if (loading) return (
    <div className="min-h-screen flex items-center justify-center bg-[#004d00] text-white font-black text-xs uppercase tracking-[0.3em] animate-pulse">
  ...
  return (
    <main className="min-h-screen bg-[#fcfdfc] font-sans text-gray-900 pb-20">
      ...
      <header className="bg-[#004d00] text-white pt-8 pb-20 px-6 rounded-b-[40px] shadow-xl relative z-10">
        ...
        {/* FIXED CONTRAST: Question Repository Header */}
        <div className="mt-10 flex items-center justify-between px-2">
           <div className="flex items-center gap-2">
              <Layers size={18} className="text-green-300" />
              <h2 className="text-xs font-black text-white uppercase tracking-[0.2em]">Question Repository</h2>
           </div>
           <span className="text-[9px] font-black text-green-200 uppercase tracking-widest">{courses.length} Units Loaded</span>
        </div>
      </header>
            ...
            <div className="grid gap-4">
              {courses.length > 0 ? courses.map((course) => (
                ...
                <div className="text-center py-12 bg-white rounded-3xl border-2 border-dashed border-gray-200">
                  ...
                  <p className="text-gray-400 text-xs font-black uppercase tracking-widest">No Data Found</p>
                </div>
              )}
            </div>
          </div>
