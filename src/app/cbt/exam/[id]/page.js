...
function ExamContent() {
  ...
  useEffect(() => {
    ...
    async function loadExam() {
      ...
      try {
        const res = await fetch(`/api/cbt/exam?courseId=${params.id}&studentId=${parsed.id}&token=${parsed.session_token}&deviceId=${hwId}`);
        ...
        if (saved) {
          ...
          // FIX: If the saved duration is different from the requested one, WIPE IT.
