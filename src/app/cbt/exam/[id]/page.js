...
function ExamContent() {
      ...
      <main className="min-h-screen bg-[#f0f2f5] font-sans pb-20 overflow-y-auto">
        <header className="bg-[#002b00] text-white pt-10 pb-20 px-6 rounded-b-[3rem] shadow-2xl relative overflow-hidden">
          ...
          <div className="relative z-10 flex flex-col items-center">
            ...
            <div className="mt-6 flex gap-4 text-[10px] font-black uppercase tracking-widest text-gray-400"><span>Score: {score}/{questions.length}</span></div>
          </div>
        </header>
  ...
  return (
    <main className="h-screen flex flex-col bg-[#f0f2f5] font-sans overflow-hidden select-none relative">
      ...
      {/* LiveTracker removed temporarily for safety */}
        ...
        <div className="fixed inset-0 z-[500] flex items-center justify-center bg-[#002b00]/90 backdrop-blur-md p-6 animate-in fade-in duration-200">
          <div className="bg-white rounded-[2.5rem] shadow-2xl max-w-sm w-full overflow-hidden border border-white">
            <div className="bg-[#004d00] p-8 flex flex-col items-center text-center border-b border-green-800 relative overflow-hidden">
              ...
              <div className="mt-4 w-full space-y-2 relative z-10"><div className="flex justify-between items-center bg-white/10 p-3 rounded-xl border border-white/10"><span className="text-[10px] font-black text-green-200 uppercase tracking-widest">Answered</span><span className="text-sm font-black text-white">{answeredCount} / {questions.length}</span></div></div>
            </div>
