    ...
    <main className="min-h-screen bg-gray-100 flex flex-col font-sans h-screen overflow-hidden">
      ...
      <header className="bg-[#004d00] text-white px-4 py-2 flex justify-between items-center shadow-md shrink-0 z-30">
        ...
        <div className="flex items-center gap-3">
          ...
          <button onClick={confirmSubmit} className="bg-red-600 hover:bg-red-700 text-white px-3 py-1.5 rounded text-xs font-bold uppercase shadow-sm">Submit</button>
        </div>
      </header>
      ...
      <div className="flex-1 flex overflow-hidden relative">
        <div className="flex-1 flex flex-col bg-white relative z-10">
          ...
          <div className="bg-gray-50 border-t border-gray-200 p-4 flex justify-between items-center shrink-0">
            ...
            <button onClick={() => navigateTo(Math.min(questions.length - 1, currentQIndex + 1))} disabled={currentQIndex === questions.length - 1} className="px-8 py-3 bg-green-700 text-white rounded-xl font-bold hover:bg-black transition-all active:scale-95 shadow-lg disabled:opacity-50">Next Question</button>
          </div>
        </div>
