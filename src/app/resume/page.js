...
export default function ResumePage() {
  ...
  return (
    <main className="min-h-screen bg-[#050505] text-white font-sans flex flex-col items-center py-8 px-4 relative z-50">
      ...
      {/* === THE DOCUMENT (A4) === */}
      <div className="print-container bg-white text-black w-full max-w-[210mm] min-h-[297mm] p-[15mm] shadow-2xl relative flex flex-col">
        ...
        <header className="border-b-4 border-black pb-4 mb-4">
          <div className="flex justify-between items-end">
            <div>
              ...
              <p className="text-xs font-bold bg-black text-white px-2 py-0.5 inline-block uppercase tracking-[0.2em]">
                Senior Full-Stack Engineer
              </p>
            </div>
            <div className="text-right flex flex-col items-end gap-1 text-[9px] font-bold uppercase tracking-wider">
        ...
        <section className="mb-4">
          ...
          <div className="grid grid-cols-2 gap-y-2 gap-x-4">
            <div>
              ...
              <p className="text-[9pt] font-bold leading-tight">Next.js 14, React, TypeScript, Node.js, Tailwind CSS</p>
            </div>
            <div>
        ...
        <section className="mb-4">
          ...
          <div className="mb-3">
            <div className="flex justify-between items-end mb-0.5">
              ...
              <span className="text-[8px] font-bold border border-black px-1.5 rounded">2023 – PRESENT</span>
            </div>
            <p className="text-[8px] font-bold text-slate-600 uppercase tracking-wider mb-1">Freelance / Contract • Remote</p>
          ...
          <div>
            <div className="flex justify-between items-end mb-0.5">
              ...
              <span className="text-[8px] font-bold border border-black px-1.5 rounded">2021 – 2023</span>
            </div>
            <p className="text-[8px] font-bold text-slate-600 uppercase tracking-wider mb-1">Various Projects</p>
            <ul className="list-disc pl-4 text-[9pt] space-y-0.5 font-medium marker:text-black">
        ...
        {/* FOOTER */}
        <footer className="mt-auto pt-4 border-t border-slate-300 flex justify-between items-end">
