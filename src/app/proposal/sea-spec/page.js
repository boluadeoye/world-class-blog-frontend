    ...
    <div className="min-h-screen bg-black font-sans text-slate-300 selection:bg-emerald-500/30 selection:text-emerald-400">
      ...
      <div className="no-print flex flex-col items-center justify-center min-h-screen p-6 relative overflow-hidden bg-black">
        ...
        <div className="relative z-10 w-full max-w-md border border-emerald-500/30 bg-black/50 backdrop-blur-xl p-10 text-center shadow-[0_0_50px_-10px_rgba(16,185,129,0.3)]">
          ...
          <p className="font-mono text-emerald-500 text-[10px] mb-8 tracking-[0.3em]">FRP-RFC-2026-001</p>
          ...
          {!isReady ? (
            <div className="space-y-2 text-left bg-emerald-950/20 p-6 border-l-2 border-emerald-500 font-mono text-[10px] text-emerald-400 h-32 flex flex-col justify-end">
              <p className="opacity-50">&gt; INJECTING JSON-LD SCHEMA...</p>
              <p className="opacity-75">&gt; CALCULATING BENNETT REFRACTION...</p>
              <p className="text-white font-bold animate-pulse">&gt; DRAFT_READY</p>
            </div>
          ) : (
      ...
      <div id="rfc-render" className="hidden print:block text-slate-300">
        ...
        <div className="a4-page flex flex-col p-[20mm]">
          ...
          <main className="grow flex flex-col justify-center relative z-10">
            ...
            <div className="grid grid-cols-2 gap-4 mb-12 font-mono text-[10px]">
              ...
              <div className="col-span-2 iso-card p-4 border-l-red-500">
                ...
                <span className="text-red-400 font-bold uppercase">Draft for C2PA Technical Working Group Evaluation</span>
              </div>
            </div>
        ...
        <div className="a4-page flex flex-col p-[20mm]">
          <div className="watermark">DRAFT FOR EVALUATION</div>
          <Header id="FRP-RFC-2026-001 // SECTION 1.0" />
          ...
          <main className="grow relative z-10">
            ...
            <div className="bg-[#0a0a0a] border border-slate-800 rounded-lg overflow-hidden shadow-2xl">
              ...
              <pre className="p-6 font-mono text-[10px] leading-relaxed text-emerald-300 overflow-x-auto">
{`{
  ...
  "integrity": {
    ...
    "manifest_super_hash": "hex_string"
        ...
        <div className="a4-page flex flex-col p-[20mm]">
          <div className="watermark">DRAFT FOR EVALUATION</div>
          <Header id="FRP-RFC-2026-001 // SECTION 2.0" />
            ...
            <div className="space-y-8">
              <div>
                ...
                <p className="font-inter text-sm text-slate-400 pl-7">
                  Given observation.geo and observation.timestamp, the validator must derive the solar position vectors (Altitude &theta; and Azimuth &phi;).
                </p>
              </div>
              ...
              <div>
                ...
                <div className="pl-7 space-y-3">
                  <div className="bg-red-950/20 border border-red-500/30 p-3 font-mono text-[10px]">
                  ...
                  <div className="bg-yellow-950/20 border border-yellow-500/30 p-3 font-mono text-[10px]">
              ...
              <div>
                ...
                <p className="font-inter text-sm text-slate-400 pl-7">
                  The header_hash_sha256 must match the first 128KB of the target file to ensure the metadata has not been re-injected into a different binary.
                </p>
              </div>
            </div>
          </main>
        ...
        <div className="a4-page flex flex-col p-[20mm]">
          <div className="watermark">DRAFT FOR EVALUATION</div>
          <Header id="FRP-RFC-2026-001 // SECTION 3.0" />
          ...
          <main className="grow relative z-10">
            ...
            <p className="font-inter text-sm text-slate-300 mb-6 leading-relaxed">
              To prevent "Boundary Spoofing", SEA implements a Gaussian Uncertainty Buffer:
            </p>
            ...
            <p className="font-inter text-sm text-slate-300 mb-8 leading-relaxed italic border-l-2 border-emerald-500 pl-4">
              Atmospheric Refraction Correction: The algorithm must account for low-altitude refraction (&lt;5&deg;) using the Bennett Formula to ensure &plusmn;0.01 arcminute precision.
            </p>

            <div className="bg-emerald-950/20 border border-emerald-500/50 p-6 relative">
              <div className="absolute -top-3 left-4 bg-black px-2 font-mono text-[10px] text-emerald-500 font-bold uppercase">Moat Logic</div>
              <p className="font-inter text-xs text-slate-300 leading-relaxed">
                Any implementation failing to account for the Bennett Formula or the IERS polar motion data will produce a signature mismatch against the FRP Reference Oracle.
              </p>
            </div>
          </main>
          <Footer />
        ...
        <div className="a4-page flex flex-col p-[20mm]">
          <div className="watermark">DRAFT FOR EVALUATION</div>
          <Header id="FRP-RFC-2026-001 // SECTION 4.0" />
            ...
            <div className="space-y-8">
              ...
              <div>
                ...
                <p className="font-inter text-sm text-slate-400">
                  The Oracle signs H using the private key. Verification is performed against the FRP Public Key published at /.well-known/frp-oracle.
                </p>
              </div>
            </div>
          </main>
        ...
        <div className="a4-page flex flex-col p-[20mm]">
          <div className="watermark">DRAFT FOR EVALUATION</div>
          <Header id="FRP-RFC-2026-001 // APPROVAL" />
...
function Header({ id }) {
  return (
    <header className="border-b border-emerald-500/30 pb-4 mb-8 flex justify-between items-end relative z-10">
      <h2 className="font-mono text-[10px] font-bold text-emerald-500 tracking-widest">{id}</h2>
  ...
  return (
    <footer className="border-t border-emerald-500/30 pt-4 mt-auto flex justify-between items-center relative z-10 bg-black">
      <span className="font-mono text-[8px] font-bold uppercase tracking-widest text-slate-500">
        CONFIDENTIAL // SOVEREIGN TRUTH // PAGE <span className="page-num text-emerald-500"></span>
      </span>
