    ...
    <div className="min-h-screen bg-black font-sans text-white selection:bg-red-900 selection:text-white">
      ...
      <div id="print-container" className="bg-black w-full max-w-[210mm] mx-auto hidden print:block">
        ...
        <div className="p-[20mm] pt-[25mm] h-[297mm] relative flex flex-col border-x-4 border-white/10">
          ...
          {/* Header */}
          <div className="flex justify-between items-end border-b-4 border-white pb-8 mb-16">
            <div>
          ...
          <section className="mb-16">
            ...
            <div className="bg-white/10 border-2 border-white/20 p-8 rounded-none">
              <p className="text-sm font-black text-white uppercase tracking-widest mb-4">The Bottom Line:</p>
          ...
          <div className="mt-auto text-right text-[10px] font-bold text-white/30 uppercase tracking-widest">Page 01 // Vision</div>
        </div>
        ...
        <div className="p-[20mm] pt-[25mm] h-[297mm] relative flex flex-col border-x-4 border-white/10">
          ...
          <section className="flex-1">
            <h2 className="text-3xl font-black uppercase border-l-8 border-red-600 pl-6 mb-12 text-white">02. Why We Will Win</h2>
            
            <div className="space-y-12">
              {/* Problem 1 */}
              <div className="flex gap-8 items-start">
                <div className="w-20 h-20 bg-red-900/20 border-2 border-red-600 flex items-center justify-center shrink-0">
              ...
              {/* Problem 2 */}
              <div className="flex gap-8 items-start">
                <div className="w-20 h-20 bg-blue-900/20 border-2 border-blue-600 flex items-center justify-center shrink-0">
              ...
              {/* Problem 3 */}
              <div className="flex gap-8 items-start">
                <div className="w-20 h-20 bg-yellow-900/20 border-2 border-yellow-600 flex items-center justify-center shrink-0">
          ...
          <div className="mt-auto text-right text-[10px] font-bold text-white/30 uppercase tracking-widest">Page 02 // Mechanics</div>
        </div>
        ...
        <div className="p-[15mm] pt-[25mm] h-[297mm] relative flex flex-col border-x-4 border-white/10">
          ...
          <section className="mb-20">
            <h2 className="text-3xl font-black uppercase border-l-8 border-white pl-6 mb-12 text-white">05. The Plan</h2>
            ...
            <div className="space-y-0 border-l-4 border-white ml-4">
              <div className="relative pl-12 pb-16">
                ...
                <h4 className="text-2xl font-black uppercase text-white mb-2">Phase 1: The Foundation</h4>
              ...
              <div className="relative pl-12 pb-16">
                ...
                <h4 className="text-2xl font-black uppercase text-red-500 mb-2">Phase 2: The Intelligence</h4>
              ...
              <div className="relative pl-12 pb-16">
                ...
                <h4 className="text-2xl font-black uppercase text-blue-500 mb-2">Phase 3: The Polish</h4>
              ...
              <div className="relative pl-12">
                ...
                <h4 className="text-2xl font-black uppercase text-white mb-2">Phase 4: Launch</h4>
          ...
          {/* 6. Final Word */}
          <section className="mb-20">
            <div className="border-4 border-white p-10 bg-white/5">
              <p className="text-xl leading-relaxed text-justify font-bold text-white">
          ...
          {/* SIGNATURE BLOCK */}
          <footer className="mt-auto pt-12 border-t-4 border-white/20 flex justify-between items-end">
            <div>
              <p className="text-xs font-black text-gray-500 uppercase tracking-widest mb-6">Architectural Approval</p>
              <div className="font-serif italic text-6xl text-white mb-4" style={{ fontFamily: 'cursive' }}>
                Boluwatife Adeoye
              </div>
              <div className="h-1 w-48 bg-red-600 mb-2"></div>
              <p className="text-base font-black text-white uppercase">Lead Technical Architect</p>
              <p className="text-xs font-bold text-gray-500">boluadeoye.com.ng</p>
            </div>
            <div className="text-right">
              <div className="w-32 h-32 border-4 border-white flex items-center justify-center font-black text-5xl text-white">
                BA
              </div>
            </div>
          </footer>
