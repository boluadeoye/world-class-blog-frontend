...
import { Download, Mail, Phone, MapPin, Linkedin, FileText, Award, BookOpen } from "lucide-react";
...
export default function OlaoluwaCV() {
  ...
  const handlePrint = () => {
    ...
    document.title = "Olaoluwa_Comfort_Olamide_Creative_Executive_CV";
    window.print();
    ...
    <div className="min-h-screen bg-slate-950 font-sans text-slate-900 selection:bg-amber-200">
      ...
      <div className="no-print flex flex-col items-center justify-center min-h-screen p-6 relative overflow-hidden">
        ...
        <div className="relative z-10 w-full max-w-md bg-white p-10 text-center shadow-2xl rounded-none border-t-8 border-[#0F172A]">
          ...
          <p className="font-inter text-[#D4AF37] text-[10px] font-bold mb-8 tracking-[0.3em] uppercase">Creative Executive CV</p>
          ...
          {!isReady ? (
            <div className="space-y-2 text-left bg-slate-50 p-6 border-l-2 border-[#0F172A] font-mono text-[10px] text-slate-500 h-32 flex flex-col justify-end">
              ...
              <p className="opacity-75">&gt; ALIGNING CREATIVE HIERARCHY...</p>
          ...
          <aside className="w-[32%] bg-[#0F172A] text-white p-[12mm] flex flex-col relative z-10">
            ...
            <div className="mb-10">
              ...
              <div className="space-y-4 font-inter text-[9px] tracking-wider text-slate-300">
                ...
                <a href="https://linkedin.com/in/olaoluwa-olamide" target="_blank" rel="noopener noreferrer" className="flex items-center gap-3 hover:text-white transition-colors">
                  <Linkedin size={12} className="text-[#D4AF37]"/> 
                  <span className="border-b border-slate-700 pb-0.5">in/olaoluwa-olamide</span>
                </a>
              </div>
            </div>

            {/* CORE COMPETENCIES (RE-ORDERED FOR CREATIVE FOCUS) */}
            <div className="mb-10">
              ...
              <div className="space-y-3">
                <div className="flex items-start gap-2">
                  ...
                  <div>
                    ...
                    <p className="font-lora text-[9px] text-slate-400">JCIN | March 2026</p>
                  </div>
                </div>
                <div className="flex items-start gap-2">
                  <Award size={12} className="text-[#D4AF37] shrink-0 mt-0.5" />
                  <div>
                    ...
                    <p className="font-lora text-[9px] text-slate-400">HP LIFE | June 2026</p>
                  </div>
                </div>
              </div>
            </div>
          ...
          <main className="w-[68%] p-[15mm] flex flex-col relative z-10">
            ...
            <header className="mb-10">
              ...
              <p className="font-inter text-xs font-black text-[#D4AF37] uppercase tracking-[0.3em]">
                Public Speaker & Content Strategist
              </p>
            </header>

            {/* EXECUTIVE SUMMARY (RE-ALIGNED FOR CREATIVE FOCUS) */}
            <section className="mb-10">
              ...
              <p className="font-lora text-[11px] leading-[1.9] text-slate-700 text-justify">
                Dynamic, Certified Public Speaker and Content Strategist with proven expertise in bridging the gap between technical brands and diverse audiences. Skilled in delivering professional voice-over audio, crafting high-impact narratives, and driving brand growth through multi-channel campaign architecture. Adept at cross-functional leadership and anchoring premier industry events within the technology ecosystem.
              </p>
            </section>

            {/* PROFESSIONAL EXPERIENCE (RE-ORDERED) */}
              ...
              <div className="relative pl-4 border-l border-slate-200 space-y-8">
                ...
                <div className="relative">
                  ...
                  <ul className="space-y-2 font-lora text-[11px] leading-[1.7] text-slate-700">
                    ...
                    <li className="flex gap-2 items-start"><span className="text-[#D4AF37] font-bold">•</span> Oversee and direct the content creation team, ensuring all digital outputs align with corporate growth metrics.</li>
                  </ul>
                </div>

                {/* Role 3: Lead Marketer */}
                <div className="relative">
                  <div className="absolute -left-[21px] top-1.5 w-2.5 h-2.5 bg-[#0F172A] rounded-full border-2 border-white"></div>
                  <div className="flex justify-between items-start mb-2">
                    <div>
                    ...
                    <span className="font-mono text-[9px] font-bold text-slate-400 uppercase bg-slate-50 px-2 py-1 rounded">Feb 2026 – July 2026</span>
                  </div>
                  <ul className="space-y-2 font-lora text-[11px] leading-[1.7] text-slate-700">
                    <li className="flex gap-2 items-start"><span className="text-[#D4AF37] font-bold">•</span> Spearheaded comprehensive digital marketing strategies that accelerated brand visibility and student enrollment.</li>
                    ...
                    <li className="flex gap-2 items-start"><span className="text-[#D4AF37] font-bold">•</span> Formulated high-impact messaging frameworks and content calendars to establish industry authority.</li>
                  </ul>
                </div>
