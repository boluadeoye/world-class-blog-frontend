      ...
      <div id="compendium-render" className="hidden print:block text-slate-300">
        ...
        <div className="a4-page tech-grid justify-between">
          ...
          <main className="grow flex flex-col justify-center relative z-10 my-auto">
            ...
            <h1 className="font-playfair text-5xl font-black text-white uppercase tracking-tighter leading-[0.9] text-center mb-6">Engineering Lifecycle &amp;<br/>Systems Compendium</h1>
            <div className="h-1 w-24 bg-[#D4AF37] mx-auto mb-8"></div>
            <p className="font-inter text-xs text-slate-400 max-w-md mx-auto text-center leading-relaxed">A comprehensive technical onboarding standard covering full-stack web architecture, system design, performance optimization, and AI-assisted workflows.</p>
          </main>
        ...
        <div className="a4-page justify-between">
          ...
          <main className="grow flex flex-col justify-center relative z-10 space-y-6">
            ...
            <div className="hud-card p-6">
              ...
              <p className="font-inter text-xs leading-relaxed text-slate-300 text-justify">&ldquo;Performance is aesthetics; security is architecture. We do not write code merely to satisfy requirements—we construct deterministic systems designed for sub-200ms latency, Zero-Trust compliance, and infinite operational elasticity.&rdquo;</p>
            </div>
            <div className="grid grid-cols-2 gap-4 font-mono text-[10px]">
              <div className="p-4 bg-white/5 border border-white/10"><span className="text-slate-500 block mb-1">Primary Discipline:</span><span className="text-white font-bold">Distributed Systems &amp; AI Edge Architecture</span></div>
              <div className="p-4 bg-white/5 border border-white/10"><span className="text-slate-500 block mb-1">Verification Key:</span><span className="text-[#D4AF37] font-bold">BA-SPEC-ORACLE-v2</span></div>
            </div>
          </main>
        ...
        <div className="a4-page justify-between">
          ...
          <main className="grow flex flex-col justify-center space-y-6">
            ...
            <p className="font-inter text-xs leading-[2] text-slate-300 text-justify">In the current technological landscape, traditional syntax-focused coding has become a commodity. AI models can produce boilerplate code in milliseconds. Consequently, the value of an engineer is no longer measured by how quickly they type syntax, but by their ability to **architect systems**.</p>
            <div className="hud-card p-6">
        ...
        <div className="a4-page justify-between">
          ...
          <main className="grow flex flex-col justify-center space-y-6">
            ...
            <div className="space-y-4">
              <div className="hud-card p-5"><h3 className="font-mono text-xs font-bold text-[#D4AF37] uppercase mb-1">1. The Client (The Presentation Tier)</h3><p className="font-inter text-xs text-slate-300 leading-relaxed text-justify">The client is the browser or mobile application executing on the user's hardware. Its sole responsibility is rendering HTML, CSS, and user interfaces while capturing interaction events. Never trust client-side state for critical security checks.</p></div>
              <div className="hud-card p-5"><h3 className="font-mono text-xs font-bold text-[#D4AF37] uppercase mb-1">2. The Server (The Application Logic Tier)</h3><p className="font-inter text-xs text-slate-300 leading-relaxed text-justify">The server is the authoritative business logic gate. It validates incoming payloads, enforces authentication rules, executes background tasks, and manages communication with external services.</p></div>
              <div className="hud-card p-5"><h3 className="font-mono text-xs font-bold text-[#D4AF37] uppercase mb-1">3. The Database (The Persistence Tier)</h3><p className="font-inter text-xs text-slate-300 leading-relaxed text-justify">The immutable storage engine. Relational databases like PostgreSQL store structured domain entities, enforce relational integrity, and guarantee atomic state updates across distributed transactions.</p></div>
            </div>
          </main>
        ...
        <div className="a4-page justify-between">
          ...
          <main className="grow flex flex-col justify-center space-y-6">
            ...
            <div className="grid grid-cols-2 gap-4 font-mono text-xs">
              <div className="p-4 bg-white/5 border border-white/10"><p className="text-[#D4AF37] font-bold uppercase mb-2">Editor Standard</p><p className="text-slate-300 text-[11px] leading-relaxed">Visual Studio Code or Cursor IDE with strict ESLint and Prettier auto-formatting on save.</p></div>
              <div className="p-4 bg-white/5 border border-white/10"><p className="text-[#D4AF37] font-bold uppercase mb-2">Runtime Environment</p><p className="text-slate-300 text-[11px] leading-relaxed">Node.js LTS (v20+) or Bun runtime engine for local script execution and NPM package resolution.</p></div>
            </div>
        ...
        <div className="a4-page justify-between">
          ...
          <main className="grow flex flex-col justify-center space-y-6">
            ...
            <p className="font-inter text-xs leading-relaxed text-slate-300 text-justify">Semantic HTML is not an aesthetic preference; it is an accessibility and structural requirement. Browsers parse semantic trees to construct the Document Object Model (DOM) and accessibility trees efficiently.</p>
          ...
          <main className="grow flex flex-col justify-center space-y-6">
            ...
            <div className="hud-card p-6">
              ...
              <div className="grid grid-cols-2 gap-6 font-inter text-xs text-slate-300">
                <div><p className="font-bold text-white mb-1">Flexbox (1D Layouts)</p><p className="text-[11px] leading-relaxed">Designed for distributing space along a single row or column. Ideal for navigation bars, button clusters, and stacked items.</p></div>
                <div><p className="font-bold text-white mb-1">CSS Grid (2D Layouts)</p><p className="text-[11px] leading-relaxed">Designed for complex two-dimensional layouts where rows and columns must align simultaneously. Ideal for dashboards and magazine spreads.</p></div>
              </div>
            </div>
            <div className="bg-[#0a0a0a] border border-slate-800 p-5 rounded font-mono text-[10px] text-emerald-400">
              ...
              <p className="text-emerald-400 font-mono">.swiss-grid -- display: grid; grid-template-columns: repeat(12, minmax(0, 1fr)); gap: 1.5rem;</p>
            </div>
          </main>
